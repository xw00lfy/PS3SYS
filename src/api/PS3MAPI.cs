    ...
    public class PS3MAPI
    {
        ...
        internal class PS3MAPI_Client_Server
        {
            ...
            internal static void Connect(string sServer, int Port)
            {
                ...
                main_ipEndPoint = new IPEndPoint(Dns.GetHostEntry(sServerIP).AddressList[0], Port);
                try
                {
            ...
            internal static void OpenDataSocket()
            {
                ...
                try
                {
                    ...
                    data_ipEndPoint = new IPEndPoint(Dns.GetHostEntry(sServerIP).AddressList[0], iPort);
